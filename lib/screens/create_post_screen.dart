...
class _CreatePostScreenState extends State<CreatePostScreen> {
  static const _garments = [
    _GarmentOption(name: 'Blazer Oversize', brand: 'Zara', bgColor: Color(0xFFF5F0EB), category: FashionCategory.coat),
    _GarmentOption(name: 'Vaqueros Slouchy', brand: 'Mango', bgColor: Color(0xFFE3F2FD), category: FashionCategory.pants),
    _GarmentOption(name: 'Vestido Satinado', brand: 'H&M', bgColor: Color(0xFFE8F5EE), category: FashionCategory.dress),
    _GarmentOption(name: 'Sneakers Blancas', brand: 'Nike', bgColor: Color(0xFFF3F4F6), category: FashionCategory.shoes),
    _GarmentOption(name: 'Camiseta Básica', brand: 'Uniqlo', bgColor: Color(0xFFFFF8F0), category: FashionCategory.tops),
    _GarmentOption(name: 'Bolso de Piel', brand: 'Massimo Dutti', bgColor: Color(0xFFFBEEE4), category: FashionCategory.accessory),
    _GarmentOption(name: 'Mini Falda', brand: 'Pull&Bear', bgColor: Color(0xFFF5F5F5), category: FashionCategory.pants),
    _GarmentOption(name: 'Tacones Negros', brand: 'Stradivarius', bgColor: Color(0xFFEEEEEE), category: FashionCategory.shoes),
    _GarmentOption(name: 'Abrigo de Lana', brand: 'Zara', bgColor: Color(0xFFF9F3EC), category: FashionCategory.coat),
    _GarmentOption(name: 'Collar Dorado', brand: 'Mango', bgColor: Color(0xFFFFF8E1), category: FashionCategory.accessory),
  ];
  ...
  void _publish() {
    ...
    if (_titleCtrl.text.trim().isEmpty) { _snack('El título es obligatorio'); return; }
    ...
    final wardrobeItems = _selectedGarments.map((i) {
      ...
      return PostWardrobeItem(
          name: g.name, brand: g.brand, bgColor: g.bgColor, category: g.category);
    }).toList();

    final effectiveCategory = _category ?? FashionCategory.tops;
    PostsService.instance.add(UserPost(
          ...
          children: [
            ...
            Center(
              child: TextButton.icon(
                ...
                label: Text(_imageFile != null ? 'Cambiar foto' : 'Añadir foto'),
            ...
            Text('Selecciona las prendas que llevas en esta publicación',
                style: GoogleFonts.dmSans(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Color.lerp(grad[0], grad[1], 0.5)!
