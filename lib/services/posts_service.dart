...
class PostsService extends ChangeNotifier {
  ...
  final List<UserPost> _posts = [
    UserPost(
      ...
      description:
          'Combinación perfecta para días calurosos. La clave está en los tonos pastel.',
      ...
      comments: [
        PostComment(
          user: 'sofia.styles',
          text: '¡Preciosa combinación! Dónde es el vestido?',
          timeAgo: '2h',
        ),
        PostComment(
          user: 'marta.fashion',
          text: 'Me encanta ese vestido satinado 😍',
          timeAgo: '1h',
        ),
      ],
    ...
    UserPost(
      ...
      title: 'Outfit formal',
      description:
          'Para la reunión del lunes. Smart casual en su máxima expresión.',
      ...
      comments: [
        PostComment(
          user: 'lucia.vintage',
          text: 'El blazer oversize es una pasada 🔥',
          timeAgo: '5h',
        ),
      ],
    ...
    UserPost(
      ...
      description:
          'Mi colección de prendas vintage favoritas. Timeless pieces que nunca pasan de moda.',
      tags: ['vintage', 'thrift', 'sostenible'],
      category: FashionCategory.coat,
      gradient: const [Color(0xFFB39DDB), Color(0xFF9C27B0)],
      wardrobeItems: const [
        PostWardrobeItem(
          name: 'Abrigo Vintage',
          brand: 'Vintage',
